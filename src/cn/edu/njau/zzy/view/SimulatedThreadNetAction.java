...
import cn.edu.njau.zzy.control.CloudsimThreadNet_Run;
 ...
 * @author zzy
 */
public class SimulatedThreadNetAction extends ActionSupport{
	...
	public String execute(){
		...
		// 创建仿真实体
		CloudsimThreadNet_Run cloudsimRun = new CloudsimThreadNet_Run(session);
