...
public class Cloudlet {
     ...
     * 用户或者代理者ID。建议由代理者使用它的个人ID来设置这个ID，因此运行结束之后云资源返回给它
	 *
     */
    private int userId;
     ...
     * (MI)). 
     * According to this length and the power of the processor (in
     * Million Instruction Per Second - MIPS) where the cloudlet will be run,
     * the cloudlet will take a given time to finish processing. 
     * For instance,
