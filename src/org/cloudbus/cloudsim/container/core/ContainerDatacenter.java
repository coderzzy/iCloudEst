...
//                    Log.printConcatLine("Assigning the container#" + container.getUid() + "to VM #" + containerVm.getUid());
                ...
                send(ev.getEntSrc(), CloudSim.getMinTimeBetweenEvents(), containerCloudSimTags.CONTAINER_CREATE_ACK, data);
    ...
    protected void processVmMigrate(SimEvent ev, boolean ack) {
        ...
        if (ack) {
            ...
            sendNow(ev.getEntSrc(), CloudSimTags.VM_CREATE_ACK, data);
        }
    ...
    protected void processContainerMigrate(SimEvent ev, boolean ack) {
        ...
        if (ack) {
            ...
            sendNow(ev.getEntSrc(), containerCloudSimTags.CONTAINER_CREATE_ACK, data);
        }
