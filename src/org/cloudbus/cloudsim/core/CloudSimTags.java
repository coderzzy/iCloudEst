 ...
 * 包含各种静态命令标签，当Cloudsim实体收到或者发送事件时候，指示Cloudsim实体需要执行的操作类型。
  *注意：为了防止与其他标签冲突，CloudSim保留负数，0 - 299和9600。
 * 
...
public class CloudSimTags {
	...
	/** Starting constant value for cloud-related tags. 启动云相关标签的常量**/
	private static final int BASE = 0;

	/** Starting constant value for network-related tags. 启动网络相关的常量**/
	...
	/** Denotes the default baud rate for CloudSim entities. 表示Cloudsim实体中的默认波特率*/
	public static final int DEFAULT_BAUD_RATE = 9600;

	/** Schedules an entity without any delay. 没有延迟调度一个实体*/
	public static final double SCHEDULE_NOW = 0.0;

	/** Denotes the end of simulation. 表示仿真结束*/
	...
	/** Sends an Experiment object between UserEntity and Broker entity 在UserEntity和Broker实体之间发送一个Experiment对象*/
	...
	/** Denotes a request to get a statistical list. 表示获取统计列表的请求*/
	 ...
	 * 表示要向Cloud区域注册CloudResource实体的请求
	 */
